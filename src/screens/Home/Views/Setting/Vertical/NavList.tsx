...
const styles = createStyle({
  container: { height: 50, flexGrow: 0, flexShrink: 0, borderBottomWidth: BorderWidths.normal, opacity: 0.7 },
  contentContainer: { flexDirection: 'row', flexWrap: 'nowrap', padding: 5 },
  listItem: { height: 40, paddingLeft: 15, paddingRight: 15, paddingHorizontal: 5, borderRadius: BorderRadius.normal, marginBottom: 5 },
  listName: { justifyContent: 'center', alignItems: 'center', flex: 1 },
})
